...
public class OSSClientUtil {
    ...
    // accessKey
    private String accessKeyId = "LTAIrziIuTLnwWz5";
    private String accessKeySecret = "B2Pdczoui6zA8zB2ChnboaAWBN6H08";
    // 空间
    private String bucketName = "save0517";
    // 文件存储目录
    private String filedir = "aliyun/";
