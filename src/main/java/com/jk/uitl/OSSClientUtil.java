...
public class OSSClientUtil {
	 public static final Logger logger = LoggerFactory.getLogger(OSSClientUtil.class);  
	    ...
	    // accessKey  
	    private String accessKeyId = "LTAIPPezC76ORmIN";  
	    private String accessKeySecret = "kLIiFbKYqPinyZKxACdyMalq7qEHGH";  
	    // 空间  
	    private String bucketName = "1801a";  
	    // 文件存储目录  
	    private String filedir = "zqs/";  
